...
const sections = [
  {
    ...
    content: [
      <>At Orexetv, we uphold the standard of our <Link className="font-bold text-[#C084FC] hover:underline" href="/pricing">IPTV subscription plans</Link>. This policy specifies when refunds may be applicable, ensuring that we maintain a transparent and just process for every customer.</>,
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      <>Connect with our support team using our <Link className="font-bold text-[#C084FC] hover:underline" href="/contact">Contact page</Link>.</>,
  ...
  },
  {
    ...
    content: [
      <>Contact: Send a message via our <Link className="font-bold text-[#C084FC] hover:underline" href="/contact">Contact page</Link></>,
  ...
  },
  {
    ...
    items: [
      <>You are discontent with the <Link className="font-bold text-[#C084FC] hover:underline" href="/channels">channel list</Link> or provided content.</>,
  ...
  },
  {
    ...
    items: [
      ...
      <>Use Setup Guides: Follow our step by step <Link className="font-bold text-[#C084FC] hover:underline" href="/installation">Installation page</Link>.</>,
      <>Ask Support First: Most issues are solved in minutes—please <Link className="font-bold text-[#C084FC] hover:underline" href="/contact">contact support</Link>.</>,
    ],
  },
];
      ...
      <article className="relative z-10">
        <header className="mb-14 text-center mx-auto max-w-3xl">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black leading-[1.08] tracking-tight uppercase">
            <span className="block text-white">Orexetv IPTV Refund &amp; Money-Back</span>
        ...
        <div className="rounded-3xl border border-white/10 bg-[#0B0714] p-8 sm:p-12 shadow-2xl backdrop-blur-xl space-y-10 text-slate-300 leading-relaxed text-sm sm:text-base">
          ...
          <section className="space-y-4 pt-6 border-t border-white/10">
            ...
            <p>If you have any questions regarding our Refund Policy, please contact our <Link className="font-bold text-[#C084FC] hover:underline" href="/contact">support team</Link>.</p>
          </section>
        </div>
      </article>
    </main>
