...
export default function Blog() {
  ...
  return (
    <main className="min-h-screen bg-[#06040F] text-white pt-6 sm:pt-10 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full relative z-10 bg-grid-pattern overflow-hidden">
