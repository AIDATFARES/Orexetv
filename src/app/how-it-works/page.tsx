...
export const metadata = {
  title: "How It Works — Fast Setup & Instant Streaming | Orexetv",
  description:
    "Get started with Orexetv in 3 simple steps: choose your plan, enter your credentials in your favorite player, and enjoy instant 4K streaming anywhere.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Get started with Orexetv in 3 simple steps: choose your plan, enter your credentials in your favorite player, and enjoy instant 4K streaming anywhere.",
    url: "https://www.orexetv.vip/how-it-works",
  },
  twitter: {
...
export default function HowItWorksPage() {
  return (
    <main className="flex-col flex min-h-screen bg-[#06040F] bg-grid-pattern text-white overflow-hidden">
      
      {/* Page Hero Header */}
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden border-b border-white/5">
        <div className="pointer-events-none absolute top-1/4 left-1/2 -translate-x-1/2 w-[850px] h-[400px] bg-[radial-gradient(circle,rgba(124,58,237,0.16)_0%,transparent_70%)]" />
      ...
      <section className="py-24 bg-[#0B0714] text-white relative z-10 border-t border-white/5">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <h2 className="text-2xl md:text-4xl font-black tracking-tight mb-12 uppercase">
            Why Choose <span className="bg-gradient-to-r from-[#C084FC] to-[#818CF8] bg-clip-text text-transparent">Orexetv IPTV</span>?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 max-w-4xl mx-auto">
            ...
            <div className="glass-card-hover flex items-center gap-4 p-5 rounded-2xl text-left">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-purple-500/10 border border-purple-500/20 text-[#C084FC]">
                <ShieldCheck size={20} />
              </div>
      ...
      <section className="py-24 bg-[#06040F] relative z-10 border-t border-white/5">
        <div className="max-w-4xl mx-auto px-6">
          <div className="relative rounded-3xl overflow-hidden border border-purple-500/30 bg-[#0B0714] p-10 sm:p-16 text-center shadow-2xl backdrop-blur-xl">
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(124,58,237,0.2)_0%,transparent_70%)]" />
            <div className="relative z-10">
              <h2 className="text-3xl md:text-5xl font-black text-white mb-4 uppercase tracking-tight">
                Ready to Start Streaming with Orexetv IPTV?
              </h2>
              <p className="text-slate-300 text-base md:text-lg font-medium mb-10 max-w-2xl mx-auto">
                Join thousands of satisfied customers. Get instant access to <Link href="/channels" className="text-[#C084FC] hover:underline font-bold">+50,000 live channels</Link>, +120,000 films &amp; series, and reliable VIP sports coverage with <Link href="/pricing" className="text-[#22D3EE] hover:underline font-bold">flexible subscription packages</Link>.
              </p>
